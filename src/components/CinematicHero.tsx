...
/**
 * Hero cinematic riusabile: parallasse immagine/contenuto, titolo statico SSR,
 * grana, scroll-cue. Rispetta prefers-reduced-motion.
 */
export default function CinematicHero({
  ...
  const scrollCueOpacity = useTransform(scrollYProgress, [0, 0.65], [1, reduce ? 1 : 0]);
